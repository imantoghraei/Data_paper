...
!  Variables 3D with attributes:
      ...
      status = nf90_put_att(ncio,uvarid,"Description", &
           "Eliassen-palm flux")
      status = nf90_def_var(ncio,"EPF_phi",nf90_float, &
           (/londimid,latdimid,levdimid,timdimid/),uvarid)
      nvar=nvar+1
      status = nf90_put_att(ncio,uvarid,"units", &
           "Pa")
     ...
     status = nf90_def_var(ncio,"d_v_mount",nf90_float, &
      ...
      status = nf90_def_var(ncio,"du_orstressdz",nf90_float, &
           (/londimid,latdimid,levdimid,timdimid/),uvarid)
      nvar=nvar+1
      status = nf90_put_att(ncio,uvarid,"units", &
           "Pa")
      status = nf90_put_att(ncio,uvarid,"Description", &
           "Vertical derivative of Or")
      status = nf90_def_var(ncio,"du_prstressdz",nf90_float, &
           (/londimid,latdimid,levdimid,timdimid/),uvarid)
      nvar=nvar+1
      status = nf90_put_att(ncio,uvarid,"units", &
           "Pa")
      status = nf90_put_att(ncio,uvarid,"Description", &
           "Vertical derivative of Pr")
      status = nf90_def_var(ncio,"du_frstressdz",nf90_float, &
           (/londimid,latdimid,levdimid,timdimid/),uvarid)
      nvar=nvar+1
      status = nf90_put_att(ncio,uvarid,"units", &
           "Pa")
      status = nf90_put_att(ncio,uvarid,"Description", &
           "Vertical derivative of Fr")
      status = nf90_def_var(ncio,"dEPFdz",nf90_float, &
           (/londimid,latdimid,levdimid,timdimid/),uvarid)
      nvar=nvar+1
      status = nf90_put_att(ncio,uvarid,"units", &
           "Pa")
      status = nf90_put_att(ncio,uvarid,"Description", &
           "Vertical derivative of EPF as a function of z")
      status = nf90_def_var(ncio,"drupwpdz",nf90_float, &
           (/londimid,latdimid,levdimid,timdimid/),uvarid)
      nvar=nvar+1
      status = nf90_put_att(ncio,uvarid,"units", &
           "Pa")
      status = nf90_put_att(ncio,uvarid,"Description", &
           "Vertical derivative of rupwp as a function of z")
      status = nf90_def_var(ncio,"dEPFdphi",nf90_float, &
           (/londimid,latdimid,levdimid,timdimid/),uvarid)
      nvar=nvar+1
      status = nf90_put_att(ncio,uvarid,"units", &
           "Pa")
      status = nf90_put_att(ncio,uvarid,"Description", &
           "Meridional derivative of EPF as a function of z")
