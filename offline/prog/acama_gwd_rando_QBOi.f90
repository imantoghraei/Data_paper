!
! $Id: acama_gwd_rando_m.F90 3531 2019-06-06 15:08:45Z fairhead $
!
...
! OFFLINE:
       !HREF(1:KLEV)=PH(KLON/2,1:KLEV)
       HREF(1:KLEV)=PH(10398,1:KLEV) ! IT: KLON/2 is changed to a grid point in the oceans (ipix=10398), since we are using healpix grids
!  END DIFFERENCE
